            ...
            <div class="grid grid-cols-1 gap-6 lg:gap-8">
                <div
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{ __('Welcome to') }} Mini CRM</h2>

                        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            {{ __('In order to start working with our application you need to log in to your account or register a new one.') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                <div class="flex items-center gap-4">
                    ...
                    @include('components.buttons.lang')
                </div>
            </div>
